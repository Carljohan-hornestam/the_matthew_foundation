<template>
    <div>
        <h4 v-if="this.$store.state.isSwedish">Vilka är vi?</h4>
        <h4 v-if="!this.$store.state.isSwedish">Who are we?</h4>
        
        <div class="row about justify-content-start pt-4 pl-3"><img src="../assets/hej.jpg"></div>
        
        <div v-if="this.$store.state.isSwedish">
        <p class="pt-4">"Jag förlorade som barn min pappa Matthew i en bilolycka. Då tappade jag tyvärr även kontakten med släkten. 2019 bestämde jag och Janne oss för att åka dit för att lära mer om kulturen och träffa min då uppspårade familj. Vi fick en fantastisk resa, mötte otroligt fina människor. Vi började med huvudstaden Abuja och åkte därefter till min familjs hemby Ozubulu.</p>
